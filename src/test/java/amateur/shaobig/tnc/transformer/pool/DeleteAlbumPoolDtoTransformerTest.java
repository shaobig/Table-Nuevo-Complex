...
class DeleteAlbumPoolDtoTransformerTest {
    ...
    @Test
    void transform() {
        DeleteAlbumDto sourceDeleteAlbumDto = new DeleteAlbumDto(1L, 0, "ALBUM_NAME", 0, AlbumType.LP, new AlbumMetadataDto(LocalDateTime.ofEpochSecond(0, 0, ZoneOffset.UTC), false), List.of(new GenreDto(1L, "GENRE_NAME", false)), List.of(new SongDto(1L, 0, "SONG_NAME", new SongMetadataDto(SongType.DEFAULT, 1))));
        ...
        DeleteAlbumPoolDto expected = new DeleteAlbumPoolDto(new DeleteAlbumDto(1L, 0, "ALBUM_NAME", 0, AlbumType.LP, new AlbumMetadataDto(LocalDateTime.ofEpochSecond(0, 0, ZoneOffset.UTC), false), List.of(new GenreDto(1L, "GENRE_NAME", false)), List.of(new SongDto(1L, 0, "SONG_NAME", new SongMetadataDto(SongType.DEFAULT, 1)))));
