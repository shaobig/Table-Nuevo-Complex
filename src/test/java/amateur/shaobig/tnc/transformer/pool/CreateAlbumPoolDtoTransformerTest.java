...
class CreateAlbumPoolDtoTransformerTest {
    ...
    @Test
    void transform() {
        CreateAlbumDto sourceCreateAlbumDto = new CreateAlbumDto(1L, 0, "ALBUM_NAME", 0, AlbumType.LP, new AlbumMetadataDto(LocalDateTime.ofEpochSecond(0, 0, ZoneOffset.UTC), false), List.of(new AlbumGenreDto(1L, true, new GenreDto(1L, "GENRE_NAME"))), List.of(new SongDto(1L, 0, "SONG_NAME", new SongMetadataDto(SongType.DEFAULT, 1))));
