...
//
//        this.createAlbumDtoTransformer = new CreateAlbumDtoTransformer(albumMetadataDtoTransformer, genreDtoTransformer, songDtoTransformer);
//    }
//
//    @Test
...
//        List<AlbumGenre> sourceAlbumGenres = List.of(new AlbumGenre(1L, "GENRE_NAME_1", false, new Album()), new AlbumGenre(1L, "GENRE_NAME_2", false, new Album()));
