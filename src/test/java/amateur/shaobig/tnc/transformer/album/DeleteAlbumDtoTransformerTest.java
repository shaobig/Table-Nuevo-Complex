...
//
//        this.deleteAlbumDtoTransformer = new DeleteAlbumDtoTransformer(albumMetadataDtoTransformer, genreDtoTransformer, songDtoTransformer);
//    }
//
//    @Test
...
//        Album sourceAlbum = new Album(1L, 0, "", 0, AlbumType.LP, new AlbumMetadata(), new Artist(), List.of(new AlbumGenre(1L, "GENRE_NAME_1", false, new Album()), new AlbumGenre(1L, "GENRE_NAME_2", false, new Album())), List.of());
//
//        deleteAlbumDtoTransformer.transform(sourceAlbum);
...
//
//        List<AlbumGenre> expected = List.of(new AlbumGenre(1L, "GENRE_NAME_1", false, new Album()), new AlbumGenre(1L, "GENRE_NAME_2", false, new Album()));
